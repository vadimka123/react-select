...
var utils = require('./utils-896a48cb.browser.cjs.js');

var index = require('./index-09f5bdbf.browser.cjs.js');
...
function (_PureComponent) {
  _inheritsLoose(ScrollBlock, _PureComponent);
...
function ScrollCaptorSwitch(_ref) {
  var _ref$isEnabled = _ref.isEnabled,
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["isEnabled"]);
...
/*#__PURE__*/
function (_Component) {
  _inheritsLoose(Select, _Component); // Misc. Instance Properties
  // ------------------------------
  // TODO
  // Refs
  // ------------------------------
  ...
  function Select(_props) {
    ...
    var _selectValue = utils.cleanValue(value);
  ...
  _proto.buildMenuOptions = function buildMenuOptions(props, selectValue) {
    var _this3 = this;
  ...
  _proto.renderMenu = function renderMenu() {
    ...
    if (this.hasOptions()) {
      menuUI = menuOptions.render.map(function (item) {
        if (item.type === 'group') {
          var type = item.type,
              group = _objectWithoutPropertiesLoose(item, ["type"]);
    ...
    var menuElement = React__default.createElement(index.MenuPlacer, _extends({}, commonProps, menuPlacementProps), function (_ref6) {
      var ref = _ref6.ref,
