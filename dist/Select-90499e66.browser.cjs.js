...
var index = require('./index-2f917010.browser.cjs.js');
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  _proto.getCommonProps = function getCommonProps() {
    ...
    var cx = index.classNames.bind(null, classNamePrefix);
    return {
      cx: cx,
  ...
  _proto.renderInput = function renderInput() {
    ...
    if (!isSearchable) {
      ...
      return /*#__PURE__*/React__default.createElement(DummyInput, _extends$4({
        id: id,
    ...
    return /*#__PURE__*/React__default.createElement(Input, _extends$4({
      autoCapitalize: "none",
      autoComplete: "off",
      autoCorrect: "off",
      cx: cx,
  ...
  _proto.renderPlaceholderOrValue = function renderPlaceholderOrValue() {
    ...
    if (!this.hasValue() || !controlShouldRenderValue) {
      return inputValue ? null : /*#__PURE__*/React__default.createElement(Placeholder, _extends$4({}, commonProps, {
        key: "placeholder",
        isDisabled: isDisabled,
        isFocused: isFocused
      }), placeholder);
    ...
    if (isMulti) {
      var selectValues = selectValue.map(function (opt, index) {
        ...
        return /*#__PURE__*/React__default.createElement(MultiValue, _extends$4({}, commonProps, {
          components: {
    ...
    return /*#__PURE__*/React__default.createElement(SingleValue, _extends$4({}, commonProps, {
      data: singleValue,
      isDisabled: isDisabled
  ...
  _proto.renderClearIndicator = function renderClearIndicator() {
    ...
    return /*#__PURE__*/React__default.createElement(ClearIndicator, _extends$4({}, commonProps, {
  ...
  _proto.renderLoadingIndicator = function renderLoadingIndicator() {
    ...
    return /*#__PURE__*/React__default.createElement(LoadingIndicator, _extends$4({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  ...
  _proto.renderIndicatorSeparator = function renderIndicatorSeparator() {
    ...
    var isFocused = this.state.isFocused;
    return /*#__PURE__*/React__default.createElement(IndicatorSeparator, _extends$4({}, commonProps, {
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  };
  ...
  _proto.renderDropdownIndicator = function renderDropdownIndicator() {
    ...
    return /*#__PURE__*/React__default.createElement(DropdownIndicator, _extends$4({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  ...
  _proto.renderMenu = function renderMenu() {
    ...
    var render = function render(props) {
      ...
      return /*#__PURE__*/React__default.createElement(Option, _extends$4({}, commonProps, props, {
        isFocused: isFocused
    ...
    if (this.hasOptions()) {
      menuUI = menuOptions.render.map(function (item) {
        if (item.type === 'group') {
          ...
          return /*#__PURE__*/React__default.createElement(Group, _extends$4({}, commonProps, group, {
    ...
    var menuElement = /*#__PURE__*/React__default.createElement(index.MenuPlacer, _extends$4({}, commonProps, menuPlacementProps), function (_ref8) {
      var ref = _ref8.ref,
          _ref8$placerProps = _ref8.placerProps,
          placement = _ref8$placerProps.placement,
          maxHeight = _ref8$placerProps.maxHeight;
      return /*#__PURE__*/React__default.createElement(Menu, _extends$4({}, commonProps, menuPlacementProps, {
        innerRef: ref,
        innerProps: {
      ...
      }, /*#__PURE__*/React__default.createElement(MenuList, _extends$4({}, commonProps, {
    ...
    return menuPortalTarget || menuPosition === 'fixed' ? /*#__PURE__*/React__default.createElement(MenuPortal, _extends$4({}, commonProps, {
  ...
  _proto.renderLiveRegion = function renderLiveRegion() {
    ...
    }, "\xA0", this.state.ariaLiveSelection), /*#__PURE__*/React__default.createElement("p", {
      id: "aria-context"
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(SelectContainer, _extends$4({}, commonProps, {
      className: className,
      innerProps: {
        id: id,
      ...
      isDisabled: isDisabled,
      isFocused: isFocused
    }), this.renderLiveRegion(), /*#__PURE__*/React__default.createElement(Control, _extends$4({}, commonProps, {
    ...
    }), /*#__PURE__*/React__default.createElement(ValueContainer, _extends$4({}, commonProps, {
      isDisabled: isDisabled
    }), this.renderPlaceholderOrValue(), this.renderInput()), /*#__PURE__*/React__default.createElement(IndicatorsContainer, _extends$4({}, commonProps, {
      isDisabled: isDisabled
