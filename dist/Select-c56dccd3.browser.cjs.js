...
var index = require('./index-a3a50fbb.browser.cjs.js');
...
var _assertThisInitialized__default = /*#__PURE__*/_interopDefault(_assertThisInitialized);
...
var _css__default = /*#__PURE__*/_interopDefault(_css);
...
function DummyInput(_ref) {
  ...
  return core.jsx("input", _extends__default['default']({
    ...
    css: /*#__PURE__*/_css__default['default']({
      label: 'dummyInput',
...
var NodeResolver = /*#__PURE__*/function (_Component) {
  ...
  function NodeResolver() {
    _classCallCheck__default['default'](this, NodeResolver);

    return _super.apply(this, arguments);
  }

  _createClass__default['default'](NodeResolver, [{
...
var ScrollLock = /*#__PURE__*/function (_Component) {
  ...
  _createClass__default['default'](ScrollLock, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
...
var ScrollBlock = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass__default['default'](ScrollBlock, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
...
var ScrollCaptor = /*#__PURE__*/function (_Component) {
  ...
  function ScrollCaptor() {
    ...
    _this.isTop = false;
    _this.isListened = false;
    _this.scrollTarget = void 0;
    _this.touchStart = void 0;
    _this.mouseStart = void 0;
    ...
    _this.onMouseDown = function (event) {
      ...
      _this.mouseStart = event.clientY;

      _this.handleEventDelta(event, 1);
    };
  ...
  _createClass__default['default'](ScrollCaptor, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/React__default['default'].createElement(NodeResolver, {
        innerRef: this.getScrollTarget
      }, this.props.children);
    }
  }]);
...
function ScrollCaptorSwitch(_ref) {
  var _ref$isEnabled = _ref.isEnabled,
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["isEnabled"]);

  return isEnabled ? /*#__PURE__*/React__default['default'].createElement(ScrollCaptor, props) : props.children;
}
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  function Select(_props) {
    ...
    _this.multiValueComponents = void 0;
    ...
    _this.cacheComponents = function (components) {
      ...
      var _this$components = _this.components,
    ...
    _this.buildMenuOptions = memoizeOne__default['default'](_this.buildMenuOptions, function (newArgs, lastArgs) {
      ...
      var _ref8 = lastArgs,
          _ref9 = _slicedToArray__default['default'](_ref8, 2),
          lastProps = _ref9[0],
  ...
  _createClass__default['default'](Select, [{
    ...
    value: function renderPlaceholderOrValue() {
      ...
      var _this$components2 = this.components,
          ...
          SingleValue = _this$components2.SingleValue,
          Placeholder = _this$components2.Placeholder;
    ...
    value: function renderIndicatorSeparator() {
      var _this$components3 = this.components,
          DropdownIndicator = _this$components3.DropdownIndicator,
          IndicatorSeparator = _this$components3.IndicatorSeparator; // separator doesn't make sense without the dropdown indicator
    ...
    value: function renderMenu() {
      ...
      var _this$components4 = this.components,
          Group = _this$components4.Group,
          GroupHeading = _this$components4.GroupHeading,
          Menu = _this$components4.Menu,
          MenuList = _this$components4.MenuList,
          MenuPortal = _this$components4.MenuPortal,
          LoadingMessage = _this$components4.LoadingMessage,
          NoOptionsMessage = _this$components4.NoOptionsMessage,
          Option = _this$components4.Option;
      var commonProps = this.commonProps;
      ...
      var render = function render(props) {
        ...
        return /*#__PURE__*/React__default['default'].createElement(Option, _extends__default['default']({}, commonProps, props, {
          isFocused: isFocused
      ...
      if (this.hasOptions()) {
        menuUI = menuOptions.render.map(function (item) {
          if (item.type === 'group') {
            item.type;
                var group = _objectWithoutProperties__default['default'](item, ["type"]);

            var headingId = "".concat(item.key, "-heading");
            return /*#__PURE__*/React__default['default'].createElement(Group, _extends__default['default']({}, commonProps, group, {
      ...
      var menuElement = /*#__PURE__*/React__default['default'].createElement(index.MenuPlacer, _extends__default['default']({}, commonProps, menuPlacementProps), function (_ref10) {
        var ref = _ref10.ref,
        ...
        return /*#__PURE__*/React__default['default'].createElement(Menu, _extends__default['default']({}, commonProps, menuPlacementProps, {
          ...
          isLoading: isLoading,
          placement: placement
        }), /*#__PURE__*/React__default['default'].createElement(ScrollCaptorSwitch, {
          isEnabled: captureMenuScroll,
          onTopArrive: onMenuScrollToTop,
          onBottomArrive: onMenuScrollToBottom
        }, /*#__PURE__*/React__default['default'].createElement(ScrollBlock, {
          isEnabled: menuShouldBlockScroll
        }, /*#__PURE__*/React__default['default'].createElement(MenuList, _extends__default['default']({}, commonProps, {
    ...
    value: function renderLiveRegion() {
      ...
      }, "\xA0", this.state.ariaLiveSelection), /*#__PURE__*/React__default['default'].createElement("span", {
        id: "aria-context"
    ...
    value: function render() {
      var _this$components5 = this.components,
          Control = _this$components5.Control,
          IndicatorsContainer = _this$components5.IndicatorsContainer,
          SelectContainer = _this$components5.SelectContainer,
          ValueContainer = _this$components5.ValueContainer;
