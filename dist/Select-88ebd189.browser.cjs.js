...
var index = require('./index-04a1c048.browser.cjs.js');
...
function DummyInput(_ref) {
  var inProp = _ref.in,
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["in", "out", "onExited", "appear", "enter", "exit", "innerRef", "emotion"]);
    ...
    value: function renderMenu() {
      ...
      if (this.hasOptions()) {
        menuUI = menuOptions.render.map(function (item) {
          if (item.type === 'group') {
            var type = item.type,
                group = _objectWithoutProperties__default['default'](item, ["type"]);
