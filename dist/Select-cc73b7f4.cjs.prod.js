...
var defaultProps = {
  ...
  function Select(_props) {
    ...
    _this.buildMenuOptions = memoizeOne__default.default(_this.buildMenuOptions, (function(newArgs, lastArgs) {
      ...
      return index.exportedEqual(newSelectValue, lastSelectValue) && index.exportedEqual(newProps.inputValue, lastProps.inputValue) && index.exportedEqual(newProps.options, lastProps.options) && index.exportedEqual(newProps.filterOption, lastProps.filterOption) && index.exportedEqual(newProps.isOptionDisabled, lastProps.isOptionDisabled);
