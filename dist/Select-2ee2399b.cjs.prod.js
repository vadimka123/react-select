...
var _objectWithoutPropertiesLoose = _interopDefault(require("@babel/runtime/helpers/objectWithoutPropertiesLoose")), _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _assertThisInitialized = _interopDefault(require("@babel/runtime/helpers/assertThisInitialized")), _inheritsLoose = _interopDefault(require("@babel/runtime/helpers/inheritsLoose")), React = require("react"), React__default = _interopDefault(React), memoizeOne = _interopDefault(require("memoize-one")), core = require("@emotion/core"), reactDom = require("react-dom"), utils = require("./utils-2db2ca57.cjs.prod.js"), index = require("./index-fbdc55b0.cjs.prod.js"), _css = _interopDefault(require("@emotion/css")), diacritics = [ {
  base: "A",
...
var canUseDOM = !("undefined" == typeof window || !window.document || !window.document.createElement), activeScrollLocks = 0, ScrollLock = function(_Component) {
  ...
  _inheritsLoose(ScrollLock, _Component);
...
var _ref$1 = {
  ...
  return _inheritsLoose(ScrollBlock, _PureComponent), ScrollBlock.prototype.render = function() {
  ...
  _inheritsLoose(ScrollCaptor, _Component);
...
function ScrollCaptorSwitch(_ref) {
  var _ref$isEnabled = _ref.isEnabled, isEnabled = void 0 === _ref$isEnabled || _ref$isEnabled, props = _objectWithoutPropertiesLoose(_ref, [ "isEnabled" ]);
...
var colors = {
  ...
  function Select(_props) {
    ...
    var _selectValue = utils.cleanValue(value), _menuOptions = _props.menuIsOpen ? _this.buildMenuOptions(_props, _selectValue) : {
      render: [],
      focusable: []
    };
  ...
  return _proto.componentDidMount = function() {
    ...
    return this.props.theme ? "function" == typeof this.props.theme ? this.props.theme(defaultTheme) : _extends({}, defaultTheme, {}, this.props.theme) : defaultTheme;
  ...
  }, _proto.buildMenuOptions = function(props, selectValue) {
    var _this3 = this, _props$inputValue = props.inputValue, inputValue = void 0 === _props$inputValue ? "" : _props$inputValue, options = props.options, toOption = function(option, id) {
      ...
      if (!(_this3.shouldHideSelectedOptions() && isSelected || !_this3.filterOption({
        ...
        }, optionId = _this3.getElementId("option") + "-" + id;
        return {
          innerProps: {
            id: optionId,
            onClick: onSelect,
    ...
    if (this.hasOptions()) menuUI = menuOptions.render.map(function(item) {
      if ("group" === item.type) {
        item.type;
        var group = _objectWithoutPropertiesLoose(item, [ "type" ]), headingId = item.key + "-heading";
