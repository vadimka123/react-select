...
var _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), _extends = require("@babel/runtime/helpers/extends"), _slicedToArray = require("@babel/runtime/helpers/slicedToArray"), _toConsumableArray = require("@babel/runtime/helpers/toConsumableArray"), _defineProperty = require("@babel/runtime/helpers/defineProperty"), _classCallCheck = require("@babel/runtime/helpers/classCallCheck"), _createClass = require("@babel/runtime/helpers/createClass"), _assertThisInitialized = require("@babel/runtime/helpers/assertThisInitialized"), _inherits = require("@babel/runtime/helpers/inherits"), _possibleConstructorReturn = require("@babel/runtime/helpers/possibleConstructorReturn"), _getPrototypeOf = require("@babel/runtime/helpers/getPrototypeOf"), React = require("react"), memoizeOne = require("memoize-one"), core = require("@emotion/core"), reactDom = require("react-dom"), index = require("./index-6196fd68.cjs.prod.js"), _css = require("@emotion/css");
...
for (var _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), _extends__default = _interopDefault(_extends), _slicedToArray__default = _interopDefault(_slicedToArray), _toConsumableArray__default = _interopDefault(_toConsumableArray), _defineProperty__default = _interopDefault(_defineProperty), _classCallCheck__default = _interopDefault(_classCallCheck), _createClass__default = _interopDefault(_createClass), _assertThisInitialized__default = _interopDefault(_assertThisInitialized), _inherits__default = _interopDefault(_inherits), _possibleConstructorReturn__default = _interopDefault(_possibleConstructorReturn), _getPrototypeOf__default = _interopDefault(_getPrototypeOf), React__default = _interopDefault(React), memoizeOne__default = _interopDefault(memoizeOne), _css__default = _interopDefault(_css), diacritics = [ {
  base: "A",
...
var defaultProps = {
  ...
  function Select(_props) {
    ...
    }, _this.getCx = function(classNamePrefix) {
      return index.classNames.bind(null, classNamePrefix);
    ...
    _this.getCx = memoizeOne__default.default(_this.getCx).bind(_assertThisInitialized__default.default(_this)), 
  ...
  return _createClass__default.default(Select, [ {
    ...
    key: "getCommonProps",
    value: function() {
      var clearValue = this.clearValue, getStyles = this.getStyles, setValue = this.setValue, selectOption = this.selectOption, props = this.props, classNamePrefix = props.classNamePrefix, isMulti = props.isMulti, isRtl = props.isRtl, options = props.options, hasValue = this.hasValue(), getValue = this.getCommonValue;
      return {
        cx: this.getCx(classNamePrefix),
