...
var _objectWithoutPropertiesLoose = _interopDefault(require("@babel/runtime/helpers/objectWithoutPropertiesLoose")), _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _inheritsLoose = _interopDefault(require("@babel/runtime/helpers/inheritsLoose")), React = require("react"), React__default = _interopDefault(React), core = require("@emotion/core"), reactDom = require("react-dom"), PropTypes = _interopDefault(require("prop-types")), utils = require("./utils-2db2ca57.cjs.prod.js"), _css = _interopDefault(require("@emotion/css")), _taggedTemplateLiteralLoose = _interopDefault(require("@babel/runtime/helpers/taggedTemplateLiteralLoose")), AutosizeInput = _interopDefault(require("react-input-autosize"));
...
var css = function(_ref) {
  ...
  _objectWithoutPropertiesLoose(props, [ "className", "cx", "getStyles", "theme", "selectProps" ]));
  return core.jsx("div", _extends({
    css: getStyles("groupHeading", _extends({
      theme: theme
    }, cleanProps)),
    className: cx({
      "group-heading": !0
  ...
  _objectWithoutPropertiesLoose(_ref2, [ "className", "cx", "getStyles", "innerRef", "isHidden", "isDisabled", "theme", "selectProps" ]));
  return core.jsx("div", {
    css: getStyles("input", _extends({
      theme: theme
    }, props))
...
var MultiValue = function(props) {
  ...
  return core.jsx(core.ClassNames, null, function(_ref6) {
    ...
    return core.jsx(Container, {
      data: data,
      innerProps: _extends({}, innerProps, {
