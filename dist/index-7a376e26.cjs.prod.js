...
var _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), _extends = require("@babel/runtime/helpers/extends"), _classCallCheck = require("@babel/runtime/helpers/classCallCheck"), _createClass = require("@babel/runtime/helpers/createClass"), _inherits = require("@babel/runtime/helpers/inherits"), React = require("react"), _defineProperty$1 = require("@babel/runtime/helpers/defineProperty"), core = require("@emotion/core"), reactDom = require("react-dom"), _typeof = require("@babel/runtime/helpers/typeof"), _css = require("@emotion/css"), _taggedTemplateLiteral = require("@babel/runtime/helpers/taggedTemplateLiteral"), AutosizeInput = require("react-input-autosize");
...
var _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), _extends__default = _interopDefault(_extends), _classCallCheck__default = _interopDefault(_classCallCheck), _createClass__default = _interopDefault(_createClass), _inherits__default = _interopDefault(_inherits), _defineProperty__default = _interopDefault(_defineProperty$1), _typeof__default = _interopDefault(_typeof), _css__default = _interopDefault(_css), _taggedTemplateLiteral__default = _interopDefault(_taggedTemplateLiteral), AutosizeInput__default = _interopDefault(AutosizeInput);
...
var _ref2 = {
  ...
  return core.jsx("svg", _extends__default.default({
    height: size,
    width: size,
    viewBox: "0 0 20 20",
    "aria-hidden": "true",
  ...
  var children = props.children, className = props.className, cx = props.cx, getStyles = props.getStyles, innerProps = props.innerProps;
  return core.jsx("div", _extends__default.default({}, innerProps, {
  ...
  return core.jsx("span", _extends__default.default({}, innerProps, {
...
var css = function(_ref) {
  ...
  }, core.jsx(Heading, _extends__default.default({}, headingProps, {
  ...
  _objectWithoutProperties__default.default(props, [ "className", "cx", "getStyles", "theme", "selectProps" ]));
  return core.jsx("div", _extends__default.default({
  ...
  _objectWithoutProperties__default.default(_ref2, [ "className", "cx", "getStyles", "innerRef", "isHidden", "isDisabled", "theme", "selectProps" ]));
  return core.jsx("div", {
    css: getStyles("input", _objectSpread2({
      theme: theme
    }, props))
  }, core.jsx(AutosizeInput__default.default, _extends__default.default({
    className: cx({
      input: !0
    }, className),
    inputRef: innerRef,
...
var MultiValue = function(props) {
  ...
  return core.jsx(core.ClassNames, null, (function(_ref6) {
    ...
    return core.jsx(Container, {
      data: data,
      innerProps: _objectSpread2(_objectSpread2({}, innerProps), {}, {
...
exports.handleInputChange = handleInputChange, exports.indicatorSeparatorCSS = indicatorSeparatorCSS, 
exports.indicatorsContainerCSS = indicatorsContainerCSS, exports.inputCSS = inputCSS, 
