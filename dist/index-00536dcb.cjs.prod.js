...
var React = require("react"), React__default = _interopDefault(React), core = require("@emotion/core"), reactDom = require("react-dom"), PropTypes = _interopDefault(require("prop-types")), _css = _interopDefault(require("@emotion/css")), AutosizeInput = _interopDefault(require("react-input-autosize")), noop = function() {};
...
function animatedScrollTo(element, to, duration, callback) {
  ...
  var start = getScrollTop(element), change = to - start, currentTime = 0;
  !function animateScroll() {
    var val = easeOutCubic(currentTime += 10, start, change, duration);
