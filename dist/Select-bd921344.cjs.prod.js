...
var _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), _extends = require("@babel/runtime/helpers/extends"), _slicedToArray = require("@babel/runtime/helpers/slicedToArray"), _toConsumableArray = require("@babel/runtime/helpers/toConsumableArray"), index = require("./index-7a376e26.cjs.prod.js"), _classCallCheck = require("@babel/runtime/helpers/classCallCheck"), _createClass = require("@babel/runtime/helpers/createClass"), _assertThisInitialized = require("@babel/runtime/helpers/assertThisInitialized"), _inherits = require("@babel/runtime/helpers/inherits"), React = require("react"), memoizeOne = require("memoize-one"), core = require("@emotion/core"), reactDom = require("react-dom"), _css = require("@emotion/css");
...
function DummyInput(_ref) {
  ...
  var innerRef = _ref.innerRef, props = (_ref.emotion, _objectWithoutProperties__default.default(_ref, [ "in", "out", "onExited", "appear", "enter", "exit", "innerRef", "emotion" ]));
