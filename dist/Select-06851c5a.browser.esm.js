...
import { a as clearIndicatorCSS, b as containerCSS, d as css, e as dropdownIndicatorCSS, g as groupCSS, f as groupHeadingCSS, i as indicatorsContainerCSS, h as indicatorSeparatorCSS, j as inputCSS, l as loadingIndicatorCSS, k as loadingMessageCSS, m as menuCSS, n as menuListCSS, o as menuPortalCSS, p as multiValueCSS, q as multiValueLabelCSS, r as multiValueRemoveCSS, s as noOptionsMessageCSS, t as optionCSS, u as placeholderCSS, v as css$1, w as valueContainerCSS, x as isTouchCapable, y as isMobileDevice, z as defaultComponents, A as isDocumentElement, B as classNames, C as exportedEqual, D as cleanValue, E as scrollIntoView, F as noop, M as MenuPlacer } from './index-49b2b5c9.browser.esm.js';
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  function Select(_props) {
    ...
    _this.getCx = memoizeOne(_this.getCx).bind(_assertThisInitialized(_this));
    _this.buildMenuOptions = memoizeOne(_this.buildMenuOptions, function (newArgs, lastArgs) {
      ...
      return exportedEqual(newSelectValue, lastSelectValue) && exportedEqual(newProps.inputValue, lastProps.inputValue) && exportedEqual(newProps.options, lastProps.options) && exportedEqual(newProps.filterOption, lastProps.filterOption) && exportedEqual(newProps.isOptionDisabled, lastProps.isOptionDisabled);
