  ...
  */
  ...
  function (_Component) {
    ...
    function Select(_props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "cacheComponents", function (components$$1) {
      ...
      _this.cacheComponents = index(_this.cacheComponents, exportedEqual).bind(_assertThisInitialized(_this));
