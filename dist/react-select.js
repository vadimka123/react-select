(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('react-dom'), require('prop-types'), require('react-input-autosize')) :
  typeof define === 'function' && define.amd ? define(['react', 'react-dom', 'prop-types', 'react-input-autosize'], factory) :
  (global.Select = factory(global.React,global.ReactDOM,global.PropTypes,global.AutosizeInput));
}(this, (function (React,reactDom,PropTypes,AutosizeInput) { 'use strict';
  ...
  */
  ...
  function merge(registered, css, className) {
    ...
    return rawClassName + /*#__PURE__*/css(registeredStyles);
  }
  ...
  */
  ...
  var DropdownIndicator = function DropdownIndicator(props) {
    ...
    return React__default.createElement(
      ...
      children || React__default.createElement(DownChevron, { emotion: emotion })
    );
  };
  ...
  var ClearIndicator = function ClearIndicator(props) {
    ...
    return React__default.createElement(
      ...
      children || React__default.createElement(CrossIcon, { emotion: emotion })
    );
  };
  ...
  var LoadingIndicator = function LoadingIndicator(props) {
    ...
    return React__default.createElement(
      ...
      React__default.createElement(LoadingDot, { emotion: emotion, color: color, delay: 0, offset: isRtl }),
      React__default.createElement(LoadingDot, { emotion: emotion, color: color, delay: 160, offset: true }),
      React__default.createElement(LoadingDot, { emotion: emotion, color: color, delay: 320, offset: !isRtl })
    );
  };
    ...
    createClass(MultiValueRemove, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(
          'div',
          innerProps,
          children || React__default.createElement(CrossIcon, { size: 14, emotion: emotion })
        );
      }
    }]);
  ...
  var getEmotion = index(function (nonce) {
    ...
    createClass(Select, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.value !== value || nextProps.options !== options || nextProps.menuIsOpen !== menuIsOpen || nextProps.inputValue !== inputValue) {
          ...
          var _menuOptions = nextProps.menuIsOpen ? this.buildMenuOptions(nextProps, _selectValue) : { render: [], focusable: [] };
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        var ensureFocus_isDisabled = isFocused && !isDisabled && prevProps.isDisabled;
      ...
      value: function renderPlaceholderOrValue() {
        ...
        if (isMulti) {
          var selectValues = selectValue.map(function (opt) {
            var isFocusedOption = opt === focusedValue;
            return React__default.createElement(
              MultiValue,
              _extends({}, commonProps, {
                components: {
  ...
  var manageState = function manageState(SelectComponent) {
    ...
    return _temp2 = _class = function (_Component) {
      ...
      return StateManager;
    }(React.Component), _class.defaultProps = defaultProps$1, _temp2;
  };
  ...
  var builtins = {
    ...
    isValidNewOption: function isValidNewOption(inputValue, selectValue, selectOptions) {
      return !(!inputValue || !selectValue || selectValue.some(function (option) {
  ...
  var makeCreatableSelect = function makeCreatableSelect(SelectComponent) {
    ...
    return _temp = _class = function (_Component) {
      ...
      return Creatable;
    }(React.Component), _class.defaultProps = defaultProps$3, _temp;
  };
