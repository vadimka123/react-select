...
var _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), _extends = require("@babel/runtime/helpers/extends"), _slicedToArray = require("@babel/runtime/helpers/slicedToArray"), _toConsumableArray = require("@babel/runtime/helpers/toConsumableArray"), index = require("./index-703d0e4e.cjs.prod.js"), _classCallCheck = require("@babel/runtime/helpers/classCallCheck"), _createClass = require("@babel/runtime/helpers/createClass"), _assertThisInitialized = require("@babel/runtime/helpers/assertThisInitialized"), _inherits = require("@babel/runtime/helpers/inherits"), React = require("react"), memoizeOne = require("memoize-one"), _css = require("@emotion/css"), core = require("@emotion/core"), reactDom = require("react-dom");
...
for (var _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), _extends__default = _interopDefault(_extends), _slicedToArray__default = _interopDefault(_slicedToArray), _toConsumableArray__default = _interopDefault(_toConsumableArray), _classCallCheck__default = _interopDefault(_classCallCheck), _createClass__default = _interopDefault(_createClass), _assertThisInitialized__default = _interopDefault(_assertThisInitialized), _inherits__default = _interopDefault(_inherits), React__default = _interopDefault(React), memoizeOne__default = _interopDefault(memoizeOne), _css__default = _interopDefault(_css), diacritics = [ {
  base: "A",
...
var _ref = {
  ...
  return core.jsx("span", _extends__default.default({
    css: _ref
  }, props));
};
...
function DummyInput(_ref) {
  ...
  return core.jsx("input", _extends__default.default({
    ref: innerRef
  }, props, {
    css: _css__default.default({
      label: "dummyInput",
      background: 0,
      border: 0,
      fontSize: "inherit",
...
var NodeResolver = function(_Component) {
  _inherits__default.default(NodeResolver, _Component);
  var _super = index._createSuper(NodeResolver);
  function NodeResolver() {
    return _classCallCheck__default.default(this, NodeResolver), _super.apply(this, arguments);
  }
  return _createClass__default.default(NodeResolver, [ {
...
var canUseDOM = !("undefined" == typeof window || !window.document || !window.document.createElement), activeScrollLocks = 0, ScrollLock = function(_Component) {
  _inherits__default.default(ScrollLock, _Component);
  var _super = index._createSuper(ScrollLock);
  function ScrollLock() {
    var _this;
    _classCallCheck__default.default(this, ScrollLock);
  ...
  return _createClass__default.default(ScrollLock, [ {
    key: "componentDidMount",
    value: function() {
      var _this2 = this;
      if (canUseDOM) {
...
var _ref$1 = {
  ...
  _inherits__default.default(ScrollBlock, _PureComponent);
  var _super = index._createSuper(ScrollBlock);
  function ScrollBlock() {
    var _this;
    _classCallCheck__default.default(this, ScrollBlock);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
  ...
  return _createClass__default.default(ScrollBlock, [ {
    key: "render",
    value: function() {
  ...
  _inherits__default.default(ScrollCaptor, _Component);
  var _super = index._createSuper(ScrollCaptor);
  function ScrollCaptor() {
    var _this;
    _classCallCheck__default.default(this, ScrollCaptor);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
    return (_this = _super.call.apply(_super, [ this ].concat(args))).isBottom = !1, 
    _this.isTop = !1, _this.isListened = !1, _this.scrollTarget = void 0, _this.touchStart = void 0, 
    _this.mouseStart = void 0, _this.cancelScroll = function(event) {
      ...
      _this.mouseStart = event.clientY, _this.handleEventDelta(event, 1);
    }, _this.onMouseUp = function(event) {
      var deltaY = event.clientY - _this.mouseStart;
  ...
  return _createClass__default.default(ScrollCaptor, [ {
    key: "componentDidMount",
    value: function() {
    ...
    value: function() {
      this.scrollTarget && (!this.isListened && this.scrollTarget.scrollHeight > this.scrollTarget.clientHeight ? this.startListening(this.scrollTarget) : this.isListened && this.scrollTarget.scrollHeight <= this.scrollTarget.clientHeight && this.stopListening(this.scrollTarget));
    }
  }, {
    key: "componentWillUnmount",
    value: function() {
    ...
    value: function(el) {
      ...
      "function" == typeof el.addEventListener && el.addEventListener("mousedown", this.onMouseDown, !1), 
      "function" == typeof el.addEventListener && el.addEventListener("mouseup", this.onMouseUp, !1), 
    ...
    value: function(el) {
      ...
      "function" == typeof el.removeEventListener && el.removeEventListener("mousedown", this.onMouseDown, !1), 
      "function" == typeof el.removeEventListener && el.removeEventListener("mouseup", this.onMouseUp, !1), 
    ...
    key: "render",
    value: function() {
      return React__default.default.createElement(NodeResolver, {
        innerRef: this.getScrollTarget
      }, this.props.children);
    }
  } ]), ScrollCaptor;
...
function ScrollCaptorSwitch(_ref) {
  var _ref$isEnabled = _ref.isEnabled, isEnabled = void 0 === _ref$isEnabled || _ref$isEnabled, props = _objectWithoutProperties__default.default(_ref, [ "isEnabled" ]);
  return isEnabled ? React__default.default.createElement(ScrollCaptor, props) : props.children;
}
...
var colors = {
  ...
  function Select(_props) {
    var _this;
    _classCallCheck__default.default(this, Select), (_this = _super.call(this, _props)).state = {
      ariaLiveSelection: "",
      ariaLiveContext: "",
      focusedOption: null,
      focusedValue: null,
    ...
    _this.commonProps = void 0, _this.components = void 0, _this.multiValueComponents = void 0, 
    _this.hasGroups = !1, _this.initialTouchX = 0, _this.initialTouchY = 0, _this.inputIsHiddenAfterUpdate = void 0, 
    _this.instancePrefix = "", _this.openAfterFocus = !1, _this.scrollToFocusedOptionOnUpdate = !1, 
    _this.userIsDragging = void 0, _this.controlRef = null, _this.getControlRef = function(ref) {
      ...
      var _this$components = _this.components, MultiValueContainer = _this$components.MultiValueContainer, MultiValueLabel = _this$components.MultiValueLabel, MultiValueRemove = _this$components.MultiValueRemove;
      _this.multiValueComponents = {
      ...
      onChange(newValue, index._objectSpread2(index._objectSpread2({}, actionMeta), {}, {
        name: name
      }));
      ...
      }) : (_this.setValue([].concat(_toConsumableArray__default.default(selectValue), [ newValue ]), "select-option", newValue), 
      ...
      _this.setState({
        ariaLiveContext: instructionsAriaMessage(event, index._objectSpread2(index._objectSpread2({}, context), {}, {
    ...
    _this.cacheComponents = memoizeOne__default.default(_this.cacheComponents, index.exportedEqual).bind(_assertThisInitialized__default.default(_this)), 
    ...
    _this.buildMenuOptions = memoizeOne__default.default(_this.buildMenuOptions, (function(newArgs, lastArgs) {
      var _ref6 = newArgs, _ref7 = _slicedToArray__default.default(_ref6, 2), newProps = _ref7[0], newSelectValue = _ref7[1], _ref8 = lastArgs, _ref9 = _slicedToArray__default.default(_ref8, 2), lastProps = _ref9[0], lastSelectValue = _ref9[1];
      return index.exportedEqual(newSelectValue, lastSelectValue) && index.exportedEqual(newProps.menuIsOpen, lastProps.menuIsOpen) && index.exportedEqual(newProps.inputValue, lastProps.inputValue) && index.exportedEqual(newProps.options, lastProps.options);
    })).bind(_assertThisInitialized__default.default(_this));
  ...
  return _createClass__default.default(Select, [ {
    ...
    value: function() {
      ...
      if (!isSearchable) return React__default.default.createElement(DummyInput, _extends__default.default({
        id: id,
      ...
      return React__default.default.createElement(Input, _extends__default.default({
        autoCapitalize: "none",
        autoComplete: "off",
        autoCorrect: "off",
        cx: cx,
    ...
    value: function() {
      ...
      if (isMulti) return selectValue.map((function(opt, index) {
        ...
        return React__default.default.createElement(MultiValue, _extends__default.default({}, commonProps, {
          components: _this4.multiValueComponents,
    ...
    value: function() {
      var _this$components3 = this.components, DropdownIndicator = _this$components3.DropdownIndicator, IndicatorSeparator = _this$components3.IndicatorSeparator;
    ...
    value: function() {
      ...
      if (this.hasOptions()) menuUI = menuOptions.render.map((function(item) {
        if ("group" === item.type) {
          item.type;
          var group = _objectWithoutProperties__default.default(item, [ "type" ]), headingId = "".concat(item.key, "-heading");
          return React__default.default.createElement(Group, _extends__default.default({}, commonProps, group, {
      ...
      var menuPlacementProps = {
      ...
      }, menuElement = React__default.default.createElement(index.MenuPlacer, _extends__default.default({}, commonProps, menuPlacementProps), (function(_ref10) {
        ...
        return React__default.default.createElement(Menu, _extends__default.default({}, commonProps, menuPlacementProps, {
          ...
          isLoading: isLoading,
          placement: placement
        }), React__default.default.createElement(ScrollCaptorSwitch, {
          isEnabled: captureMenuScroll,
          onTopArrive: onMenuScrollToTop,
          onBottomArrive: onMenuScrollToBottom
        }, React__default.default.createElement(ScrollBlock, {
          isEnabled: menuShouldBlockScroll
        }, React__default.default.createElement(MenuList, _extends__default.default({}, commonProps, {
      ...
      if (name && !isDisabled) {
        if (isMulti) {
          ...
          var input = selectValue.length > 0 ? selectValue.map((function(opt, i) {
            var optionValue = _this6.getOptionValue(opt);
            return React__default.default.createElement("input", {
              key: optionValue,
              name: name,
              type: "hidden",
    ...
    value: function() {
      return this.state.isFocused ? React__default.default.createElement(A11yText, {
        "aria-live": "polite"
      }, React__default.default.createElement("span", {
        id: "aria-selection-event"
      }, " ", this.state.ariaLiveSelection), React__default.default.createElement("span", {
        id: "aria-context"
    ...
    key: "render",
    value: function() {
      var _this$components5 = this.components, Control = _this$components5.Control, IndicatorsContainer = _this$components5.IndicatorsContainer, SelectContainer = _this$components5.SelectContainer, ValueContainer = _this$components5.ValueContainer, _this$props22 = this.props, className = _this$props22.className, id = _this$props22.id, isDisabled = _this$props22.isDisabled, menuIsOpen = _this$props22.menuIsOpen, isFocused = this.state.isFocused, commonProps = this.commonProps = this.getCommonProps();
