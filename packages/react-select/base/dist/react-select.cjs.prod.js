...
var _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _toConsumableArray = _interopDefault(require("@babel/runtime/helpers/toConsumableArray")), _objectSpread = _interopDefault(require("@babel/runtime/helpers/objectSpread")), _classCallCheck = _interopDefault(require("@babel/runtime/helpers/classCallCheck")), _createClass = _interopDefault(require("@babel/runtime/helpers/createClass")), _possibleConstructorReturn = _interopDefault(require("@babel/runtime/helpers/possibleConstructorReturn")), _getPrototypeOf = _interopDefault(require("@babel/runtime/helpers/getPrototypeOf")), _assertThisInitialized = _interopDefault(require("@babel/runtime/helpers/assertThisInitialized")), _inherits = _interopDefault(require("@babel/runtime/helpers/inherits")), _defineProperty = _interopDefault(require("@babel/runtime/helpers/defineProperty")), React = require("react"), React__default = _interopDefault(React), memoizeOne = _interopDefault(require("memoize-one")), core = require("@emotion/core"), reactDom = require("react-dom");

require("prop-types"), require("@babel/runtime/helpers/typeof"), require("raf");

var __chunk_1 = require("../../dist/chunk-c9662232.cjs.prod.js"), __chunk_2 = require("../../dist/chunk-1c9d6d4d.cjs.prod.js"), _css = _interopDefault(require("@emotion/css"));
...
var colors = {
  ...
  function Select(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function(newValue, actionMeta) {
      ...
      event.stopPropagation(), _this.openAfterFocus = !1, setTimeout(function() {
...
_defineProperty(Select, "defaultProps", defaultProps), exports.default = Select, 
