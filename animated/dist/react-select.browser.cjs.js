...
require('react-dom');
require('prop-types');
var index$1 = require('../../dist/index-2f917010.browser.cjs.js');
require('@emotion/css');
...
var AnimatedMultiValue = function AnimatedMultiValue(WrappedComponent) {
  return function (_ref) {
    ...
    return /*#__PURE__*/React__default.createElement(Collapse, {
      in: inProp,
      onExited: onExited
    }, /*#__PURE__*/React__default.createElement(WrappedComponent, _extends$1({
...
var AnimatedPlaceholder = function AnimatedPlaceholder(WrappedComponent) {
  return function (props) {
    return /*#__PURE__*/React__default.createElement(Fade, _extends$2({
...
var AnimatedSingleValue = function AnimatedSingleValue(WrappedComponent) {
  return function (props) {
    return /*#__PURE__*/React__default.createElement(Fade, _extends$3({
      component: WrappedComponent
    }, props));
  };
};
...
var AnimatedValueContainer = function AnimatedValueContainer(WrappedComponent) {
  return function (props) {
    return /*#__PURE__*/React__default.createElement(reactTransitionGroup.TransitionGroup, _extends$4({
      component: WrappedComponent
    }, props));
  };
};
