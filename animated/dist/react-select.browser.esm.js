...
import 'react-dom';
import 'prop-types';
import { E as exportedEqual, C as defaultComponents } from '../../dist/index-fa9c31b3.browser.esm.js';
import '@emotion/css';
...
var AnimatedMultiValue = function AnimatedMultiValue(WrappedComponent) {
  return function (_ref) {
    ...
    return /*#__PURE__*/React.createElement(Collapse, {
      in: inProp,
      onExited: onExited
    }, /*#__PURE__*/React.createElement(WrappedComponent, _extends$1({
...
var AnimatedPlaceholder = function AnimatedPlaceholder(WrappedComponent) {
  return function (props) {
    return /*#__PURE__*/React.createElement(Fade, _extends$2({
...
var AnimatedSingleValue = function AnimatedSingleValue(WrappedComponent) {
  return function (props) {
    return /*#__PURE__*/React.createElement(Fade, _extends$3({
      component: WrappedComponent
    }, props));
  };
};
...
var AnimatedValueContainer = function AnimatedValueContainer(WrappedComponent) {
  return function (props) {
    return /*#__PURE__*/React.createElement(TransitionGroup, _extends$4({
      component: WrappedComponent
    }, props));
  };
};
